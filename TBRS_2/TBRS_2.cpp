...
#pragma endregion
    ...
    std::cout << "OpenMP:\t\t" << multiplyOpenMP(A, B, C).count() << " microseconds" << std::endl;
    resetMatrix(C);
    std::cout << "Sequential:\t" << multiplyLinearIJK(A, B, C).count() << " microseconds" << std::endl;
    resetMatrix(C);
    /*std::cout << "IKJ result:\t" << multiplyLinearIKJ(A, B, C).count() << " microseconds" << std::endl;
    resetMatrix(C);
    ...
    resetMatrix(C);*/
    std::cout << "Optimal seq:\t" << multiplyLinearKIJ(A, B, C).count() << " microseconds" << std::endl;
    resetMatrix(C);
